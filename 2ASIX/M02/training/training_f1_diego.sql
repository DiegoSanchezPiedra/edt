...
ADD FOREIGN KEY (oficina_rep)
REFERENCES oficinas(oficina);

--incorrecte:
--insert into repventas values ('111','Diego Sanchez','20','30','Rep Ventas','17-MAR-00','104','350000','367911');
--correcte:
--insert into repventas values ('111','Diego Sanchez','20','11','Rep Ventas','17-MAR-00','104','350000','367911');

ALTER TABLE clientes
ADD FOREIGN KEY (rep_clie)
REFERENCES repventas(num_empl);

--incorrecte:
--insert into clientes values ('3111','S.A.','205',40000);
--correcte:
--insert into clientes values ('3111','S.A.','105',40000);
...
--values 
--('112','Juan Gomez','40','13','Rep Ventas','1988-02-12','204',350000,367911);

--correcte:
--insert into repventas
--values 
--('112','Juan Gomez','40','13','Rep Ventas','1988-02-12','104',350000,367911);
...
--values
--(23,'Barcelona','Este',205,300000,187042);

--correcte:
--insert into oficinas
--values
--(23,'Barcelona','Este',105,300000,187042);

DELETE FROM PEDIDOS
WHERE num_pedido=113051;

ALTER TABLE pedidos
ADD FOREIGN KEY (fab,producto)
REFERENCES productos(id_fab,id_producto);

--ESBORRAR EL PEDIDO DEL PRODUCTE K47

--DELETE FROM PEDIDOS
--WHERE producto='k47';

--MILLOR FER SERVIR CLAUS UNIQUES
...
--insert into pedidos
--values
--(113051,'10-FEB-90',2118,108,QSA,'XK47',4,1420);
...
--insert into pedidos
--values
--(213042,'02-FEB-90',2113,201,'REI','2A44R',5,22500);

--correcte:
--insert into pedidos
--values
--(213042,'03-FEB-90',2113,101,'REI','2A44R',3,12500);

ALTER TABLE pedidos
ADD FOREIGN KEY (clie)
REFERENCES clientes(num_clie);

--incorrecte:
--insert into pedidos
--values
--(213043,'03-FEB-90',3113,101,'REI','2A44R',3,12500);
